<template>
  <header>
    <span class="i-logos-vitejs" title="ViteJS" />
    <span class="i-icon-park-plus-cross" />
    <span class="i-logos-typescript-icon"  title="TypeScript" />
    <span class="i-icon-park-plus-cross" />
    <span class="i-logos-vue"   title="Vue 3" />
    <span class="i-icon-park-plus-cross" />
    <span class="i-logos-vuetifyjs"  title="Vuetify 3"/>
    <span class="i-icon-park-plus-cross" />
